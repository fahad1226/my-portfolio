...
export function Globe({ globeConfig, data }: WorldProps) {
    ...
    const _buildData = () => {
        if (!data || !Array.isArray(data) || data.length === 0) {
            console.warn("Globe: Invalid or empty data array");
            setGlobeData([]);
            return;
        }
        ...
        for (let i = 0; i < arcs.length; i++) {
            ...
            // Validate color and coordinates
            if (!rgb) {
    ...
    const startAnimation = () => {
        ...
        // Filter out invalid arcs with NaN or invalid coordinates
        ...
        globeRef.current
            ...
            .arcAltitude((e) => {
                ...
                return typeof alt === "number" && !isNaN(alt) ? alt : 0;
            })
            .arcStroke((e) => {
        ...
        // Use globeData (processed points) instead of data (arcs)
        ...
        globeRef.current
            ...
            .pointColor((e) => {
                const color = (e as { color: string | ((t: number) => string) })
                    .color;
                // If color is a function, call it with t=0 to get the base color

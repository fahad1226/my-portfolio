...
export const gridItems = [
  ...
  },
  {
    id: 3,
    title: "My Tech Stack",
    description: "Most experienced with these technologies",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
...

  {
    id: 5,
    title:
      "Building an Algorithm Visualizer Web App from scratch for Easy Understanding of Basic University Algorithms",
